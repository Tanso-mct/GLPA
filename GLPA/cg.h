...
#define VIEWVOLUME_TOP_V1 RECT_BACK_TOP_LEFT
#define VIEWVOLUME_TOP_V2 RECT_BACK_TOP_RIGHT
#define VIEWVOLUME_TOP_V3 RECT_FRONT_TOP_RIGHT
#define VIEWVOLUME_TOP_V4 RECT_FRONT_TOP_LEFT

#define VIEWVOLUME_FRONT_V1 RECT_FRONT_TOP_LEFT
#define VIEWVOLUME_FRONT_V2 RECT_FRONT_TOP_RIGHT
#define VIEWVOLUME_FRONT_V3 RECT_FRONT_BOTTOM_RIGHT
#define VIEWVOLUME_FRONT_V4 RECT_FRONT_BOTTOM_LEFT

#define VIEWVOLUME_RIGHT_V1 RECT_FRONT_TOP_RIGHT
#define VIEWVOLUME_RIGHT_V2 RECT_BACK_TOP_RIGHT
#define VIEWVOLUME_RIGHT_V3 RECT_BACK_BOTTOM_RIGHT
#define VIEWVOLUME_RIGHT_V4 RECT_FRONT_BOTTOM_RIGHT

#define VIEWVOLUME_LEFT_V1 RECT_BACK_TOP_LEFT
#define VIEWVOLUME_LEFT_V2 RECT_FRONT_TOP_LEFT
#define VIEWVOLUME_LEFT_V3 RECT_FRONT_BOTTOM_LEFT
#define VIEWVOLUME_LEFT_V4 RECT_BACK_BOTTOM_LEFT

#define VIEWVOLUME_BACK_V1 RECT_BACK_TOP_RIGHT
#define VIEWVOLUME_BACK_V2 RECT_BACK_TOP_LEFT
#define VIEWVOLUME_BACK_V3 RECT_BACK_BOTTOM_LEFT
#define VIEWVOLUME_BACK_V4 RECT_BACK_BOTTOM_RIGHT

#define VIEWVOLUME_BOTTOM_V1 RECT_BACK_BOTTOM_RIGHT
#define VIEWVOLUME_BOTTOM_V2 RECT_BACK_BOTTOM_LEFT
#define VIEWVOLUME_BOTTOM_V3 RECT_FRONT_BOTTOM_LEFT
#define VIEWVOLUME_BOTTOM_V4 RECT_FRONT_BOTTOM_RIGHT
