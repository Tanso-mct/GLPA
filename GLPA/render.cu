...
//     cudaMemcpy(dResult, dResult, sizeof(float)*resultSize, cudaMemcpyHostToDevice);
...
//     (
//         dPolyVs, dPolyNs, polyNs.size() / 3, 
//         dMtCamTransRot, dMtCamRot, cam.farZ / CALC_SCALE, cam.nearZ / CALC_SCALE,
//         dCamViewAngleCos, dViewVolumeNs, dViewVolumeNs, dNearScSize, dScPixelSize, dResult
//     );
//     cudaMemcpy(hResult, dResult, sizeof(double)*resultSize , cudaMemcpyDeviceToHost);
